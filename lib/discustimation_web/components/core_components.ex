defmodule DiscustimationWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(DiscustimationWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(DiscustimationWeb.Gettext, "errors", msg, opts)
    end
  end
